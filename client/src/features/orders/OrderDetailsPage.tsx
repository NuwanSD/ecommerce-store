...
export default function OrderDetailsPage() {
  ...
  const { data: order, isLoading } = useFetchOrderDetailedQuery(+id!); //casting no into integer and ! ignore the ts
  ...
  return (
    <Card sx={{ p: 3, maxWidth: "md", mx: "auto" }}>
            ...
            {order?.orderItems.map((item) => (
              ...
              >
                ...
                <TableCell align="right" sx={{ p: 4 }}>
                  x {currencyFormat(item.price * item.quantity)}
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
